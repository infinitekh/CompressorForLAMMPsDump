...
typedef struct  {
	int  nTime;                              /*!< \brief t : time  */
	int    n_atoms;                               /*!< \brief n : the number of atom */
	int atomType;
	Box3 box;                                     /*!< \brief Box property */
	atomstream* streams;                                  /*!< \brief atom[0..n-1] */
} Atomstream_list;
/*!
...
int free_atomstreamlist(Atomstream_list *);
int malloc_atomstreamlist(Atomstream_list *);
Atomstream_list *  new_atomstreamlist();
int fill_atomstreamlist(Atomstream_list*, FILE*);
#endif
